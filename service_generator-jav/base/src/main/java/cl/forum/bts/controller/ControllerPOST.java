@ApiOperation(value = "####operation_description####", notes = "####operation_notes####")
	...
	@PostMapping(value = "####endpoint_out####", produces = "application/json")
	public ResponseEntity<Object> ####method_http####(@RequestHeader(name = "Canal", required = true) String canal,
			...
			@RequestHeader(name = "Device", required = true) String device, @Valid @RequestBody ####mainEntity#### mainEntity,
			HttpServletRequest request
			####path_vars_main####) throws ResponseException, ParseException, IOException {
